 ...
 */
public class MarkLogicPersistenceManager13Defunct extends AbstractPersistenceManager
{
	private static final Logger log = LoggerFactory.getLogger (MarkLogicPersistenceManager13Defunct.class);
...
//	private static final char[] HEXDIGITS = "0123456789abcdef".toCharArray ();
	...
	private MarkLogicFileSystem13 contextFS;
	 ...
	 */
	public MarkLogicPersistenceManager13Defunct ()
	{
		initialized = false;
	}
	...
	public void init (PMContext context) throws Exception
	{
		...
		if ( ! (context.getFileSystem() instanceof MarkLogicFileSystem13)) {
			throw new IllegalArgumentException ("Must be used with MarkLogicFileSystem");
		}

		contextFS = (MarkLogicFileSystem13) context.getFileSystem();
		itemStateFS = new BasedFileSystem(context.getFileSystem(), "/data");
		blobStore = new MarkLogicBlobStore13 (itemStateFS);
