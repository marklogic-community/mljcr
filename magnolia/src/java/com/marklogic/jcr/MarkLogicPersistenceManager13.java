 ...
 */
public class MarkLogicPersistenceManager13 extends AbstractPersistenceManager
{
	private static final Logger log = LoggerFactory.getLogger (MarkLogicPersistenceManager13.class);
